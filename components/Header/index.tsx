...
export const Header = ({ videos }: headerProps): ReactElement => {
  ...
  return (
    <div className="min-w-screen flex items-center justify-center border-b border-gray-300">
      <header className="w-full max-w-screen-2xl p-5 flex justify-between items-center 2xl:bg-blue-900 bg-blue-800 ">
        <div>
          <Link href="/#posts">
            <a>
